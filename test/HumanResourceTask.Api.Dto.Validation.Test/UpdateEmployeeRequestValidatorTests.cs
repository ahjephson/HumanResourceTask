...
namespace HumanResourceTask.Api.Dto.Validation.Test
{
    ...
    {
        private readonly UpdateEmployeeRequestValidator _target = new UpdateEmployeeRequestValidator();

        [Fact]
        public void GIVEN_IdIsEmpty_WHEN_ValidatingRequestObject_THEN_ShouldFailValidationWithMessage()
        {
